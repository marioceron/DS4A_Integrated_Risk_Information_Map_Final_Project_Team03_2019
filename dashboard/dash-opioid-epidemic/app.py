...
--where cod_departamento = '05' \n \
group by cast(date_trunc('month',hd.fecha) as date), d.divipola_id, d.municipio, d.cod_departamento, d.departamento", engine.connect())
...
def display_map(year, figure):
    ...
    geojson_colombia = 'data/colombia_limpio.geojson'
