...
\title{Datathon Project Group 3\\
Unveiling Transportation Coverage Maps of New York}
...
%\begin{abstract}
%
%This document describes the process followed to define, analyze and answer  the question of the Datathon project. The document provides information of the data cleaning process and some plots with preliminar results of the data wrangling process.
%
%
%\end{abstract}
...
%This document describes the process followed to define, analyze and answer  the question of the Datathon project. 
